...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jshashes'), require('https')) :
  typeof define === 'function' && define.amd ? define(['jshashes', 'https'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.wtfImage = factory(global.require$$0, global.require$$0$1));
  ...
  const Hashes = require$$0__default["default"];
  ...
  const https = require$$0__default$1["default"]; // use the native nodejs request function
